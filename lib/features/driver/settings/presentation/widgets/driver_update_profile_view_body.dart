...
class DriverUpdateProfileViewBody extends StatefulWidget {
  const DriverUpdateProfileViewBody({super.key});

  @override
  State<DriverUpdateProfileViewBody> createState() =>
      _UserUpdateProfileViewBodyState();
}

class _UserUpdateProfileViewBodyState extends State<DriverUpdateProfileViewBody> {
  File? file;
