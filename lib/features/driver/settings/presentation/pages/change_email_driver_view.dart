...
import 'package:taxi_app/features/driver/settings/presentation/widgets/change_email_driver_view_body.dart';

class ChangeEmailDriverView extends StatelessWidget {
  const ChangeEmailDriverView({super.key});
    ...
    return BlocProvider(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(LocaleKeys.change_email.tr()),
        ),
        body: SafeArea(child: ChangeEmailDriverViewBody()),
      ),
    );
  }
}
