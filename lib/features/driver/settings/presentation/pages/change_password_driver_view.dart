...
import 'package:taxi_app/features/driver/settings/presentation/widgets/change_password_driver_view_body.dart';

class ChangePasswordDriverView extends StatelessWidget {
  const ChangePasswordDriverView({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        body: SafeArea(child: ChangePasswordDriverViewBody()),
      ),
    );
  }
}
