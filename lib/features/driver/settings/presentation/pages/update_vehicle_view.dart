...
import 'package:taxi_app/features/driver/settings/presentation/widgets/update_vehicle_view_body.dart';

class UpdateVehicleView extends StatelessWidget {
  const UpdateVehicleView({super.key});
    ...
    return BlocProvider(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(LocaleKeys.update_vehicle.tr()),
        ),
        body: SafeArea(child: UpdateVehicleViewBody()),
      ),
    );
  }
}